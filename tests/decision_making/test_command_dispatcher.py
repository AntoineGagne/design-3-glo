...
from design.decision_making.rotation_commands import RotationCheckCommand
...
def test_when_step_is_rotation_towards_capture_get_relevant_command_returns_rotation_check_command():
    ...
    assert isinstance(command, RotationCheckCommand)
